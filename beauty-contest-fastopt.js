...
/** @constructor */
function $c_Lbeautycontest_HelloWorld0$() {
  $c_O.call(this)
}
$c_Lbeautycontest_HelloWorld0$.prototype = new $h_O();
$c_Lbeautycontest_HelloWorld0$.prototype.constructor = $c_Lbeautycontest_HelloWorld0$;
/** @constructor */
function $h_Lbeautycontest_HelloWorld0$() {
  /*<skip>*/
}
$h_Lbeautycontest_HelloWorld0$.prototype = $c_Lbeautycontest_HelloWorld0$.prototype;
$c_Lbeautycontest_HelloWorld0$.prototype.init___ = (function() {
  return this
});
$c_Lbeautycontest_HelloWorld0$.prototype.$$js$exported$meth$main__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLCanvasElement__O = (function(target, targetCanvas) {
  return this.main__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lorg_scalajs_dom_raw_Node(target, targetCanvas)
});
$c_Lbeautycontest_HelloWorld0$.prototype.main__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lorg_scalajs_dom_raw_Node = (function(target, targetCanvas) {
  var box = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().input__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().type__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("text", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().placeholder__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("Type here!", $m_Lscalatags_JsDom$all$().stringAttr$1)])).render__Lorg_scalajs_dom_raw_Element();
  var output = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().span__Lscalatags_generic_TypedTag()).render__Lorg_scalajs_dom_raw_Element();
  box.onkeyup = (function(f) {
    return (function(arg1) {
      return f.apply__O__O(arg1)
    })
  })(new $c_Lbeautycontest_HelloWorld0$$anonfun$main$4().init___Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lorg_scalajs_dom_raw_HTMLInputElement__Lorg_scalajs_dom_raw_HTMLSpanElement(target, targetCanvas, box, output));
  var jsx$6 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
  var jsx$5 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().h1__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Capital Box!"))]));
  var jsx$4 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().p__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Type here and have it capitalized!"))]));
  ...
  var jsx$2 = jsx$3.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$3, box)]));
  ...
  return target.appendChild(jsx$6.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$5, jsx$4, jsx$2, jsx$1.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$4, output)]))])).render__Lorg_scalajs_dom_raw_Element())
});
$c_Lbeautycontest_HelloWorld0$.prototype.main = (function(arg$1, arg$2) {
  var prep0 = arg$1;
  var prep1 = arg$2;
  return this.$$js$exported$meth$main__Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLCanvasElement__O(prep0, prep1)
});
var $d_Lbeautycontest_HelloWorld0$ = new $TypeData().initClass({
  Lbeautycontest_HelloWorld0$: 0
}, false, "beautycontest.HelloWorld0$", {
  Lbeautycontest_HelloWorld0$: 1,
  O: 1
});
$c_Lbeautycontest_HelloWorld0$.prototype.$classData = $d_Lbeautycontest_HelloWorld0$;
var $n_Lbeautycontest_HelloWorld0$ = (void 0);
function $m_Lbeautycontest_HelloWorld0$() {
  if ((!$n_Lbeautycontest_HelloWorld0$)) {
    $n_Lbeautycontest_HelloWorld0$ = new $c_Lbeautycontest_HelloWorld0$().init___()
  };
  return $n_Lbeautycontest_HelloWorld0$
}
$e.beautycontest = ($e.beautycontest || {});
$e.beautycontest.HelloWorld0 = $m_Lbeautycontest_HelloWorld0$;
/** @constructor */
function $c_Lbeautycontest_playaround$() {
  $c_O.call(this)
}
$c_Lbeautycontest_playaround$.prototype = new $h_O();
$c_Lbeautycontest_playaround$.prototype.constructor = $c_Lbeautycontest_playaround$;
/** @constructor */
function $h_Lbeautycontest_playaround$() {
  /*<skip>*/
}
$h_Lbeautycontest_playaround$.prototype = $c_Lbeautycontest_playaround$.prototype;
$c_Lbeautycontest_playaround$.prototype.init___ = (function() {
  return this
});
$c_Lbeautycontest_playaround$.prototype.main__Lorg_scalajs_dom_raw_HTMLCanvasElement__V = (function(canvas) {
  ...
  canvas.onmousemove = (function(canvas$1, renderer$1, down$1$2) {
    return (function(e$2) {
      ...
      if (down$1$2.elem$1) {
        renderer$1.fillRect(($uD(e$2.clientX) - $uD(rect.left)), ($uD(e$2.clientY) - $uD(rect.top)), 10.0, 10.0)
      }
    })
  })(canvas, renderer, down)
});
$c_Lbeautycontest_playaround$.prototype.$$js$exported$meth$main__Lorg_scalajs_dom_raw_HTMLCanvasElement__O = (function(canvas) {
  this.main__Lorg_scalajs_dom_raw_HTMLCanvasElement__V(canvas)
});
$c_Lbeautycontest_playaround$.prototype.main = (function(arg$1) {
  var prep0 = arg$1;
  return this.$$js$exported$meth$main__Lorg_scalajs_dom_raw_HTMLCanvasElement__O(prep0)
});
var $d_Lbeautycontest_playaround$ = new $TypeData().initClass({
  Lbeautycontest_playaround$: 0
}, false, "beautycontest.playaround$", {
  Lbeautycontest_playaround$: 1,
  O: 1
});
$c_Lbeautycontest_playaround$.prototype.$classData = $d_Lbeautycontest_playaround$;
var $n_Lbeautycontest_playaround$ = (void 0);
function $m_Lbeautycontest_playaround$() {
  if ((!$n_Lbeautycontest_playaround$)) {
    $n_Lbeautycontest_playaround$ = new $c_Lbeautycontest_playaround$().init___()
  };
  return $n_Lbeautycontest_playaround$
}
$e.beautycontest = ($e.beautycontest || {});
$e.beautycontest.playaround = $m_Lbeautycontest_playaround$;
/** @constructor */
...
$c_sjsr_RuntimeLong.prototype.$classData = $d_sjsr_RuntimeLong;
/** @constructor */
function $c_Lbeautycontest_HelloWorld0$$anonfun$main$4() {
  $c_sr_AbstractFunction1.call(this);
  this.target$1$2 = null;
  this.targetCanvas$1$2 = null;
  this.box$1$2 = null;
  this.output$1$2 = null
}
$c_Lbeautycontest_HelloWorld0$$anonfun$main$4.prototype = new $h_sr_AbstractFunction1();
$c_Lbeautycontest_HelloWorld0$$anonfun$main$4.prototype.constructor = $c_Lbeautycontest_HelloWorld0$$anonfun$main$4;
/** @constructor */
function $h_Lbeautycontest_HelloWorld0$$anonfun$main$4() {
  /*<skip>*/
}
$h_Lbeautycontest_HelloWorld0$$anonfun$main$4.prototype = $c_Lbeautycontest_HelloWorld0$$anonfun$main$4.prototype;
$c_Lbeautycontest_HelloWorld0$$anonfun$main$4.prototype.apply__O__O = (function(v1) {
  return this.apply__Lorg_scalajs_dom_raw_Event__O(v1)
});
$c_Lbeautycontest_HelloWorld0$$anonfun$main$4.prototype.apply__Lorg_scalajs_dom_raw_Event__O = (function(e) {
  var jsx$1 = this.output$1$2;
  var thiz = $as_T(this.box$1$2.value);
  ...
  if (($as_T(e.key) === "Enter")) {
    var x$1 = $as_T(this.output$1$2.textContent);
    ...
    if (($as_T(this.output$1$2.textContent) === "HELLO")) {
      this.target$1$2.appendChild($as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().h1__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Hello World!"))])), $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().p__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("The quick brown ")), $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().b__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("fox"))])), ($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T(" jumps over the lazy ")), $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().i__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("dog"))])), ($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("."))]))])).render__Lorg_scalajs_dom_raw_Element())
    };
    if (($as_T(this.output$1$2.textContent) === "DRAW")) {
      $m_Lbeautycontest_playaround$().main__Lorg_scalajs_dom_raw_HTMLCanvasElement__V(this.targetCanvas$1$2)
    };
    if (($as_T(this.output$1$2.textContent) === "CLOCK")) {
      var renderer = this.targetCanvas$1$2.getContext("2d");
      this.targetCanvas$1$2.width = $uI(this.targetCanvas$1$2.parentElement.clientWidth);
      this.targetCanvas$1$2.height = $uI(this.targetCanvas$1$2.parentElement.clientHeight);
      var gradient = renderer.createLinearGradient((((-100) + (($uI(this.targetCanvas$1$2.width) / 2) | 0)) | 0), 0.0, ((100 + (($uI(this.targetCanvas$1$2.width) / 2) | 0)) | 0), 0.0);
      ...
      return $uI($m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().setInterval((function(arg$outer, renderer$2) {
        return (function() {
          arg$outer.beautycontest$HelloWorld0$$anonfun$$render$1__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V(renderer$2)
        })
      })(this, renderer), 1000.0))
    } else {
      return (void 0)
    }
  } else {
...
$c_Lbeautycontest_HelloWorld0$$anonfun$main$4.prototype.beautycontest$HelloWorld0$$anonfun$$render$1__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V = (function(renderer$2) {
  var date = new $g.Date();
  renderer$2.clearRect(0.0, 0.0, $uI(this.targetCanvas$1$2.width), $uI(this.targetCanvas$1$2.height));
  renderer$2.font = "75px sans-serif";
  renderer$2.fillText($as_sc_TraversableOnce($m_sc_Seq$().apply__sc_Seq__sc_GenTraversable(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$uI(date.getHours()), $uI(date.getMinutes()), $uI(date.getSeconds())]))).mkString__T__T(":"), (($uI(this.targetCanvas$1$2.width) / 2) | 0), (($uI(this.targetCanvas$1$2.height) / 2) | 0))
});
$c_Lbeautycontest_HelloWorld0$$anonfun$main$4.prototype.init___Lorg_scalajs_dom_raw_HTMLDivElement__Lorg_scalajs_dom_raw_HTMLCanvasElement__Lorg_scalajs_dom_raw_HTMLInputElement__Lorg_scalajs_dom_raw_HTMLSpanElement = (function(target$1, targetCanvas$1, box$1, output$1) {
  this.target$1$2 = target$1;
  this.targetCanvas$1$2 = targetCanvas$1;
  this.box$1$2 = box$1;
  this.output$1$2 = output$1;
  return this
});
var $d_Lbeautycontest_HelloWorld0$$anonfun$main$4 = new $TypeData().initClass({
  Lbeautycontest_HelloWorld0$$anonfun$main$4: 0
}, false, "beautycontest.HelloWorld0$$anonfun$main$4", {
  Lbeautycontest_HelloWorld0$$anonfun$main$4: 1,
  sr_AbstractFunction1: 1,
  O: 1,
  F1: 1,
  s_Serializable: 1,
...
$c_Lbeautycontest_HelloWorld0$$anonfun$main$4.prototype.$classData = $d_Lbeautycontest_HelloWorld0$$anonfun$main$4;
/** @constructor */
